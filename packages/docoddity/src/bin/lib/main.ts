...
export const main = async ({
  ...
  // const themePath = path.join(internalDir, '_data/theme.json');
  // const themeParsedStylesAndScripts = await parseStylesAndScripts({
  //   inputDir,
  //   internalDir,
  //   createFile,
  //   ...themeJSON,
  // });
  // const parsedThemeJSON = {
  //   ...themeJSON,
  //   ...themeParsedStylesAndScripts,
  // };
  // await writeFile(themePath, (await transformTags(parsedThemeJSON, themeDir)));
  // await parseAndWriteDataFile(parsedThemeJSON, 'theme', {
  //   inputDir,
  //   internalDir,
  //   createFile,
  // });
