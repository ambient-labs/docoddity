...
// const themeToggle = $_('button#theme-toggle');
// if (themeToggle) {
...
//     themeToggle.title = `Switch between dark and light mode (currently ${mode} mode)`;
//     themeToggle.setAttribute('aria-label', `Switch between dark and light mode (currently ${mode} mode)`);
//   }
//   setTheme(theme === 'dark' || (!theme && prefersDarkScheme.matches) ? 'dark' : 'light');
